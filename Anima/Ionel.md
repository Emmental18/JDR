...
**AGI:** 6+2(bottes)  **CON:** 9  **DEX:** 6  **FOR:** 4  **INT:** 13  **PER:** 5  **POU:** 10  **VOL:** 4
...
**Points de Vie :** 120(CON)+5×2(Classe)+(Multiplicateurs: PFs)+(Avantage) = 130  \
Restants :

***
##### CHAMPS PRINCIPAUX : ( PFs)
***
## Champ Martial : (300 PFs)

**Compétences** (110 Pfs): \
 Attaque: (Base)+5(Dex)+5×2(Classe)=  \
 Esquive: (Base)+10(Agi)+×(Classe)=  \
 Parade: 55(Base)+5(Dex)+20(Classe)= 80  \
...
- **Nom : Juste rétribution** Niveau : 2 \
    ...
    DI : 55   Ki: 40 POU/FOR/VOL/DEX (+11)  
...
**Développement intérieur total:** 50×2(Classe)+50(Arts Martiaux)+( PFs)= 150 \
Utilisé: 145 \
Rang d'apprentissage:  \
Pouvoirs de puissance intérieure : (80 DI) 
